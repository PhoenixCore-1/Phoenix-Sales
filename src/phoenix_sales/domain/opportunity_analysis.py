...
class OpportunityAnalysis:
    ...
    def from_context(cls, context: SalesCopilotContextPackage) -> "OpportunityAnalysis":
        ...
        for key in ("stage", "probability", "estimated_value", "solution_value", "quote_value", "order_value", "quote_status", "quote_expiry", "competitor", "margin", "last_activity", "next_action"):
            fact = values.get(key)
